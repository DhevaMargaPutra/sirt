											...
											<tbody>
												...
												<tr>
													...
													<td style="text-align: center">
														<a href="<?php print base_url()."acl/menu/menu_sub_sub/$vs->id_menu/$vs->id_menu_sub"?>">
 															<button class="btn btn-success btn-sm">
 																<i class="fa fa-list" aria-hidden="true"></i> Sub Menu
 															</button>
 														</a>
														<a href="<?php print base_url().'acl/menu/edit_sub_data/'.$vs->id_menu .'/'.$vs->id_menu_sub; ?>">
							...
							<div class="card-content">
								<div class="card-body">
									<form class="form form-horizontal" method="POST"
										action="<?php print base_url()?>acl/menu/simpan_sub_menu" novalidate>
										<div class="form-body">
											<div class="row">
												<div class="col-12">
