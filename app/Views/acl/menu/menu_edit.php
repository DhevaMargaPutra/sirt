 							...
 							<div class="card-content">
 								<div class="card-body">
 									<form class="form form-horizontal" method="POST"
 										action="<?php print base_url()?>acl/menu/update_menu" novalidate>
 										<div class="form-body">
 											<div class="row">
 												<div class="col-12">
 													<div class="form-group row">
 														...
 														<div class="col-md-8">
															 ...
															 <input type="hidden" name='api_url' value="<?php print $menu->api_url;?>">
															 <input class="form-control" id="basicInput" placeholder=""
															 value="<?php print $menu->nm_menu;?>"
 													...
 													<div class="form-group row">
 														...
 														<div class="col-md-4">
 															<div class="vs-radio-con">
																 ...
																 <?php if($menu->status == '1'){ print "checked";}?>
 																	data-validation-required-message="">
 																<span class="vs-radio">
 														...
 														<div class="col-md-4">
 															<div class="vs-radio-con">
																 ...
																 <?php if($menu->status == '0'){ print "checked";}?>
 																	data-validation-required-message="">
 																<span class="vs-radio">
 																	<span class="vs-radio--border"></span>
 																	<span class="vs-radio--circle"></span>
