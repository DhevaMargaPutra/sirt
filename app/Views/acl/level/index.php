 			...
 			<div class="col-12">
 				...
 				<div class="breadcrumb-wrapper col-12">
 					<ol class="breadcrumb">
 						...
 						<li class="breadcrumb-item"><a href="<?php print base_url()?>acl/level">Level</a>
 						</li>
 					</ol>
 				</div>
 			</div>
 				...
 				<div class="row match-height">
 					<div class="col-md-12 col-12">
 						<div class="card"  >
 							...
 							<div class="card-content">
 								<div class="card-body">
 									<form class="form form-horizontal" method="POST" action="<?php print base_url()?>acl/level/simpan_level" novalidate>
 										<div class="form-body">
 											<div class="row">
											 <div class="col-12">
