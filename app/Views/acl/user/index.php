 				...
 				<div class="row match-height">
 					<div class="col-md-12 col-12">
 						<div class="card"  >
 							...
 							<div class="card-content">
 								<div class="card-body">
 									<form class="form form-horizontal" method="POST" action="<?php print base_url()?>acl/user/simpan_user" novalidate>
 										<div class="form-body">
 											<div class="row">
											 <div class="col-12">
 													<div class="form-group row">
 														...
 														<div class="col-md-8">
 															<input class="form-control" id="basicInput" placeholder=""
 																type="text" name="username"    required data-validation-required-message="">
 														</div>
 													</div>
 												</div>
 												<div class="col-12">
 													...
 													<div class="form-group row">
 														...
 														<div class="col-md-8">
 															<input type="password" id="password" class="form-control"
 																name="password" placeholder="Password"   required data-validation-required-message="" >
 														</div>
 													</div>
 												</div>
 												<div class="col-12">
 														...
 														<div class="col-md-8">
 															<select class="form-control select2" id="basicSelect" name ="level_key"   data-validation-required-message="" >
																...
																<?php foreach ($level as $value): ?>
																	<option value="<?php echo $value->level_key ?>"><?php echo $value->level_name ?></option>
																<?php endforeach?>
 															</select>
 														</div>
 													</div>
 														...
 														<div class="col-md-8">
 															<select class="form-control select2" id="basicSelect" name ="id_balai"   data-validation-required-message="" >
																...
																<?php foreach ($balai as $value): ?>
																	<option value="<?php echo $value->id_balai ?>"><?php echo $value->nama_balai ?></option>
																<?php endforeach?>
 															</select>
 														</div>
 													</div>
